...
from mrfi.experiment import BER_Acc_experiment, logspace_density, Acc_golden, benchmark_range, get_weight_range
...
print(get_weight_range(fi_model, module_type = ['Conv2d', 'Linear'], weight_name=['weight', 'bias']))
...
np.savez('result/vgg16_weight.npz', BER = BER, fxp2 = fxp2, fxp3 = fxp3, fl32 = fl32, Qlw = Qlw)